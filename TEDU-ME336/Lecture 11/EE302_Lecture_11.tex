...
\newcommand{\lecture}[4]{
   ...
   \framebox{
      \vbox{\vspace{2mm}
    \hbox to 6.28in { {\bf TEDU - ME 336 \hfill Modeling and Control of Dynamic Systems} }
       \vspace{4mm}
       \hbox to 6.28in { {\Large \hfill Lecture #1 \hfill} }
       \vspace{2mm}
       \hbox to 6.28in { {\it Lecturer: #2 \hfill } }
       \vspace{1mm}
       \hbox to 6.28in { \footnotesize
         \parbox{6.28in}{This lecture note is originally prepared by Dr. Mert Ankarali for METU EE-302.\newline(Source: https://github.com/mertankarali/Lecture-Notes)} }
      \vspace{2mm}}
   }
   \end{center}
...
% Lecture Details
\lecture{11}{Dr. Kutlu D. Kandemir}
...
Routh's Stability Criterion (a.k.a  Routhâ€“Hurwitz stability criterion)
